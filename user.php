    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="user.php">
                ...
                <div class="sidebar-brand-text mx-3">Aplikasi Catatan Perjalanan<sup></sup></div>
            </a>
                        ...
                        <?php 
                            if(!empty(@$_GET['url'])){
                                switch (@$_GET['url']){
                                    ...
                                    case 'simpan_catatan':
                                        include 'simpan_catatan.php';
                                        break;
                                        case 'lihat_catatan_kegiatan':
                                        include 'lihat_catatan_kegiatan.php';
                                        break;     
                                }
                            }else{
                                echo "Selamat datang di Aplikasi Catatan Perjalanan. ";
